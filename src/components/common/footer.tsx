          ...
          <div className="md:col-span-6 lg:col-span-3 flex flex-col gap-3">
            ...
            <div className="flex gap-2">
             ...
             <Link href="https://www.instagram.com/?hl=en"
              target="_blank"
              className="w-9 h-9 bg-black rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform" aria-label="Instagram">
              ...
              <Link href="https://web.facebook.com/?_rdc=1&_rdr"
               target="_blank"
               className="w-9 h-9 bg-black rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform" aria-label="Facebook">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
              ...
              <Link href="https://x.com/" 
                target="_blank"
                 className="w-9 h-9 bg-black rounded-full flex items-center justify-center text-white hover:scale-110 transition-transform" aria-label="Twitter X">
